...
$sql = "
SELECT p.id, per.paterno, per.materno, per.nombre, c.nombre AS concepto, p.monto, p.modo_pago, p.fecha_pago
FROM pagos p
...
while ($row = $result->fetch_assoc()) {
    echo "<tr>
        ...
        <td><button class='btn btn-sm btn-danger' onclick='eliminarPago({$row['id']})'>Eliminar</button></td>
    </tr>";
}
